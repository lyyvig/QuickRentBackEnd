...
namespace Business.Constants {
    public static class Messages {
        ...
        public static readonly string WrongPasswordOrEmail = "Wrong password or email";
        ...
        public static readonly string BalanceInsufficent = "Balance is insufficient ";
        
        public static readonly string FindexScoreInsufficient = "Findex score is insufficient ";
        
        public static readonly string ReturnDateLessThanRentDate = "Return date must be later than rent date";
        public static readonly string CustomerHasNoNationalIdentity = "You need to addyour national identity to rent a car";
        public static readonly string InformationUpdated = "Information updated";
    }
